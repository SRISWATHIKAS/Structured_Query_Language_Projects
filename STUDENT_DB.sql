...
SELECT COUNT(Student_Name) AS Total_Students
FROM StudentCareer;
...
SELECT Placement_Status , COUNT(Placement_Status) AS Placed_Student
FROM StudentCareer
